...
PRODUCTS = {
    'Sejaro 2.5mg': {
        ...
        'photo_url': 'https://drive.google.com/uc?id=1iGm21bVW3k9oxX8cKu1YNaiz37Ficr5H&export=download',  # Замени на свою ссылку
    },
    'Sejaro 5mg': {
        'price': 101000,
    ...
    'Sejaro 10mg': {
        ...
        'photo_url': 'https://drive.google.com/uc?id=1vSP84bdF7ThlqujRetEJF5RMN8fsAWaO&export=download',
    },
    'Sejaro 12.5': {
        'price': 145000,
...
PAYMENT_DETAILS = """
Метод оплаты  выберете вы когда с вами свяжется администатор для уточнения деталей заказа.
📱 Отправка осуществляется компанией CDEK найдите адрес ближайшего пункта выдачи.
✉️ Ожидайте с вами скоро ссвяжутся.
"""
